...
namespace GeNa.Core
{
    ...
    public class GeNaTerrainExtensionEditor : GeNaSplineExtensionEditor
    {
        ...
        {
            GeNaTerrainExtension extension = target as GeNaTerrainExtension;
            EditorGUI.BeginChangeCheck();
            {
                extension.Width = m_editorUtils.FloatField("Width", extension.Width, HelpEnabled);
                switch (extension.EffectType)
                {
                ...
                extension.Strength = m_editorUtils.Slider("Strength", extension.Strength, 0f, 1f, HelpEnabled);
                ...
                if (GUILayout.Button(extension.EffectType.ToString()))
                    extension.Clear();
            }
