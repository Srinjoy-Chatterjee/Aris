...
namespace GeNa.Core
{
    ...
    public class GeNaClearCollidersExtensionEditor : GeNaSplineExtensionEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GeNaClearCollidersExtension extension = target as GeNaClearCollidersExtension;
            EditorGUI.BeginChangeCheck();
            {
                extension.Width = m_editorUtils.FloatField("Width", extension.Width, HelpEnabled);
                extension.LayerMask = m_editorUtils.LayerMaskField("Layer Mask", extension.LayerMask, HelpEnabled);
                DropCollidersGUI();
